...
export default function Corolla() {
  return (
    <div className="bg-zinc-200  ">
      <div>
        <h1 className="flex justify-center text-3xl font-semibold  underline my-5">
          Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs
        </h1>
        <img className=" mx-auto " src="/Toyotac.jpg" alt="" />
      </div>
      ...
      <div className="flex justify-center py-4 ">
        ...
        <h3 className="px-1 mr-4">1800 CC</h3>
        <h2 className="font-bold ">Condition:</h2>
        <h3 className="px-1 mr-4">8.5 / 10</h3>
