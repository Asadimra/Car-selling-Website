    ...
    <div className="bg-zinc-200  ">
      <div>
        <h1 className="flex justify-center text-3xl font-semibold  underline ">
          Honda Alto  2024 Price in Pakistan, Images, Reviews & Specs
        </h1>
        <img className="my-10 mx-auto w-5/12  " src="/Altoc.png" alt="" />
      </div>
      ...
      <div className="flex justify-center py-4 ">
        ...
        <h3 className="px-1 mr-4">660 CC</h3>
        <h2 className="font-bold ">Condition:</h2>
        <h3 className="px-1 mr-4">9.5 / 10</h3>
      ...
      <div className="flex justify-center  ">
        ...
        <h3 className="px-1 mr-4">25 km per litre</h3>
